    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
        <div class="panel-heading">
          <h6 class="panel-title"><i class="icon-book3"></i> Data Jurnal Bimbingan <b><?php echo ucwords($user->row()->nama_lengkap); ?></b> <a class="heading-elements-toggle"><i class="icon-more"></i></a></h6>
                  ...
                  <tbody>
                      ...
                      ?>
                          <tr>
                            ...
                            <td>
                              <a href="users/jurnal/d/<?php echo $baris->kdjurnal; ?>" class="btn btn-info btn-xs"><i class="icon-eye"></i></a>
                            </td>
                          </tr>
                      <?php
                      $no++;
