        ...
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
              ...
              <fieldset class="content-group">
                ...
                ?>
                <center>
                  <img src="foto/<?php if ($user->foto == '') { echo'default.png'; } elseif ($sub_menu3 == 'd_pemb') { echo"pembimbing/$user->foto"; }else{echo "siswa/$user->foto";}?>" alt="<?php echo $user->nama_lengkap; ?>" class="img-circle" width="176" height="176">
                  <br>
                  <b>
